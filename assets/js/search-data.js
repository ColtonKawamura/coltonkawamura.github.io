...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "CV",
          description: "A mix of my experience, education, and skills from both industry and academia. You can also download my CV as a PDF.",
          section: "Navigation",
          handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/ColtonKawamura", "_blank");
        },
      },{
        id: 'social-cv',
        title: 'CV',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=MWmZoaAAAAAJ", "_blank");
        },
      },{
